...
const CACHE = 'ps-v1.7.7';
/* 系统默认的她（v1.6.1）：普通与 Q版两张最关键的先预缓存，其余表情差分随抓随存
   ⚠️ v1.7.6 起这两张是 .webp（上传的那份 mimi/ 全是压过的 .webp，PNG 原图在家里的「原图备份/」）。
      v1.7.7 起它们住在 mimi/表情/（mimi/ 拆成了 5 个文件夹，见 index.html 的 artFolder）。
      以后你要是把图换成别的格式或挪了文件夹，这里两条也要跟着改 —— 改错了不影响使用
      （下面 addAll 有 catch，装不上就跳过），只是那两张失去了「断网也能开」的待遇 */
const SHELL = ['./', './index.html', './manifest.json', './apple-touch-icon.png', './favicon.png', './mimi/表情/normal.webp', './mimi/表情/q.webp'];
